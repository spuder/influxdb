...
func (self *DataTestSuite) Test_Issue334_Derivative_ConsecutiveBuckets_NoFill(c *C) {
	data := `
[
  {
	"name": "data",
...
func (self *DataTestSuite) Test_Issue334_Derivative_NonConsecutiveBuckets_NoFill(c *C) {
	data := `
[
  {
	"name": "data",
